...
let ``League table correctly joins teams``() = 
    ...
    let firstResult = new Result(new ResultForTeam("Arsenal",2,1), new ResultForTeam("Man C",1,2), new DateTime(2015,1,1))
...
let ``Aggregates results``() = 
    ...
    let parsedTeams = teamParser.parseLines teamsToParse |> List.ofArray
    let firstResult = new Result(new ResultForTeam("Arsenal",2,1), new ResultForTeam("Man C",1,2), new DateTime(2015,1,1))
    let secondResult = new Result(new ResultForTeam("Gunners",1,1), new ResultForTeam("Manchester City",1,1), new DateTime(2015,1,1))
...
let ``Removes teams with no results``() = 
    ...
    let firstResult = new Result(new ResultForTeam("Arsenal",2,1), new ResultForTeam("Man C",1,2), new DateTime(2015,1,1))
    let secondResult = new Result(new ResultForTeam("Gunners",1,1), new ResultForTeam("Manchester City",1,1), new DateTime(2015,1,1))
    let thirdIgnoredResult = new Result(new ResultForTeam("Derby",1,1), new ResultForTeam("Manchester City",1,1), new DateTime(2016,1,1))
    let results = [firstResult; secondResult; thirdIgnoredResult]
